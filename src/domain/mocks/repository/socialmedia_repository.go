...
func (_m *SocialMediaRepository) DeleteById(_a0 context.Context, _a1 string) error {
...
func (_m *SocialMediaRepository) FindAllByUser(_a0 context.Context, _a1 *[]domain.SocialMedia, _a2 string) error {
...
func (_m *SocialMediaRepository) FindById(_a0 context.Context, _a1 *domain.SocialMedia, _a2 string) error {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *SocialMediaRepository) Save(_a0 context.Context, _a1 *domain.SocialMedia) error {
	ret := _m.Called(_a0, _a1)
...
func (_m *SocialMediaRepository) Update(_a0 context.Context, _a1 domain.SocialMedia, _a2 string) (domain.SocialMedia, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, domain.SocialMedia, string) (domain.SocialMedia, error)); ok {
